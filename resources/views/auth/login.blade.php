...
<!----------------------------- Form box ----------------------------------->
    <div class="form-box">
        ...
        <div class="register-container" id="register">
            ...
            <div class="input-box">
                <div class="input-box">
                    <input type="text" name="name" value="{{ old('name') }}" class="input-field" placeholder="Username" required>
                    <i class="bx bx-user"></i>
                </div>
            </div>
            <div class="input-box">
                <input type="text" name="email" value="{{ old('email') }}" class="input-field" placeholder="Email" required>
            ...
            <div class="input-box">
                <input type="password" name="password_confirmation" required class="input-field" placeholder="Password Confirmation">
                <i class="bx bx-lock-alt"></i>
            </div>
            <div class="input-box">
        ...
        <div class="d-flex flex-column-reverse" style="margin-top: -100px; color: white;">
